        ...
        <div className="mt-5">
            ...
            <div className="flex justify-center mt-3">
                ...
                <button
                    onClick={handleClick}
                    disabled={loading}
                    className={`bg-[#2ca01c] hover:bg-[#248a15] text-white w-full sm:w-auto sm:px-16 py-4 text-[12px] sm:text-sm font-bold tracking-wider rounded-sm transition-colors flex items-center justify-center gap-2 ${loading ? 'opacity-70 cursor-not-allowed' : ''
                        }`}
                >
                    {loading ? (
                        <>
